...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Kyro for Business — Grow Revenue Without Ads",
      ...
      <section style={{ backgroundColor: "rgb(11,5,29)", padding: "80px 0" }}>
        <div style={{ maxWidth: "1140px", margin: "0 auto", padding: "0 24px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "48px", alignItems: "center" }} className="ai-grid">
          ...
          <div style={{ borderRadius: "16px", overflow: "hidden" }}>
            <Image src="/images/business/business-hero.png" alt="Business owner with loyalty analytics" width={560} height={315} style={{ width: "100%", height: "auto" }} />
          </div>
        </div>
      </section>
