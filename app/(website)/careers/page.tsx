...
export const metadata: Metadata = {
  ...
  description: "Join Kyro and help local businesses thrive. We're hiring engineers, designers, and marketers. Remote-first, meaningful work.",
  alternates: { canonical: "/careers" },
  openGraph: {
    title: "Careers at Kyro — Build the Future of Local Business",
    description: "Join Kyro and help local businesses thrive. We're hiring engineers, designers, and marketers.",
    url: "/careers",
  },
};
