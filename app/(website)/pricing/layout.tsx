...
const pricingJsonLd = {
  ...
  "@type": "Product",
  name: "Fidely Digital Loyalty Platform",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Pricing", item: "https://fidely.com/pricing" },
  ],
};
