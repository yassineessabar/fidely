        ...
        >
          {success ? (
            ...
            <div style={{ textAlign: "center", padding: "40px 0" }}>
              ...
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="rgb(22,163,74)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <p style={{ fontSize: "15px", color: "rgb(97,95,109)", lineHeight: "22px", maxWidth: "380px", margin: "0 auto" }}>
                We&apos;ve sent a confirmation to <strong style={{ color: "rgb(11,5,29)" }}>{formData.email}</strong>. Our team will review your application and get back to you within 24 hours.
              </p>
              <p style={{ fontSize: "13px", color: "rgb(97,95,109)", marginTop: "24px" }}>
            ...
            <>
              ...
              <p style={{ marginTop: "24px", fontSize: "12px", fontWeight: 400, lineHeight: "17px", color: "rgb(97,95,109)" }}>
                ...
                <a href="/terms" style={{ color: "rgb(11,5,29)", textDecoration: "underline", textUnderlineOffset: "1.8px" }}>
                  Terms of Service
                </a>{" "}
                and{" "}
                <a href="/privacy" style={{ color: "rgb(11,5,29)", textDecoration: "underline", textUnderlineOffset: "1.8px" }}>
                  Privacy Policy
                </a>.
              </p>
