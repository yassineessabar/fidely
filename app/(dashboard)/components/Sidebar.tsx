            ...
            <>
              ...
              <div style={{
                ...
                <div style={{ padding: "10px 12px", marginBottom: "4px" }}>
                  <p style={{ margin: 0, fontSize: "13px", fontWeight: 600, color: "rgba(10,10,10,0.9)" }}>{bizName || "My Business"}</p>
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "8px 14px 0", minWidth: "260px" }}>
        ...
        >
          <div>
            <p style={{ margin: 0, fontSize: "13px", fontWeight: 600, color: "rgba(10,10,10,0.8)" }}>Upgrade your plan</p>
            <p style={{ margin: "3px 0 0", fontSize: "11px", color: "rgba(10,10,10,0.35)", fontWeight: 500 }}>Get more features</p>
          </div>
      ...
      {onNavClick && (
        <button onClick={onNavClick} className="dash-close-btn"
          style={{ display: "none", position: "absolute", top: "16px", right: "16px", background: "rgba(10,10,10,0.06)", border: "none", borderRadius: "8px", padding: "6px", cursor: "pointer", color: "rgba(10,10,10,0.5)" }}>
          <X size={18} />
        </button>
      )}
    </aside>
